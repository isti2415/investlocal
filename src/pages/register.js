        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="lg:grid min-h-screen lg:grid-cols-12">
                ...
                >
                    <img
                        src="/register.png"
                        class="absolute inset-0 h-full object-cover opacity-80"
                    />
                    ...
                    <div class="hidden lg:relative lg:block lg:p-12">
                        <div>
                            ...
                            <img src="/money.png" alt="InvestLocal Logo" class="inline-block h-16"/>
                        </div>

                        <p class="mt-4 leading-relaxed text-white/90">
                            Transforming the Local Investment Landscape: InvestLocal is Here to Help
                        </p>
                    </div>
                </section>
